...
| :--- | :--- | :--- | :--- |
| **1. Kallio** | Synology DS1621+ | SHR-2 / Btrfs | Kaikkein kriittisin ja korvaamaton data |
| **2. Sora** | WD My Cloud Pro PR4100 | RAID 5 / Ext4 (tai vastaava) | Tärkeä arkidata ja medialirastot |
...
## 1. Kallio (`1-kallio-shr2` / `1. Kallio [SHR2]`)
